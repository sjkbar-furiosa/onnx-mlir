...
class ONNXDepthToSpaceOpLowering : public ConversionPattern {
public:
  ONNXDepthToSpaceOpLowering(MLIRContext *ctx)
      : ConversionPattern(ONNXDepthToSpaceOp::getOperationName(), 1, ctx) {}
  ...
  LogicalResult matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    Value reshapeRes1 = onnxBuilder.reshape(input, outputDims1);
    ...
    Value transposeRes = onnxBuilder.transpose(reshapeRes1, perm, outputDims2);
    ...
    Value reshapeRes2 = onnxBuilder.reshape(transposeRes, outputDims3);
